...
\abstractEN{The~main goal of this thesis is to test the influence of several heuristics on the effectivenes of solving numerical CSP problems by interval propagation. Constraint safisfaction problem (CSP) is a~problem of finding the~values of variables while satisfying all the given constraints. A~problem solver written in the F\# language utilizing the HC3 algorithm and a branch-and-prune algorithm has been created, important aspects of the HC3 algorithm influencing its effectivenes have been found and then experiments with \textbf{NUMBER} different heuristics were performed. The results found in the thesis can be used when deciding which heuristic to use when solving constraint systems.}
